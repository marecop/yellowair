  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="bg-white p-8 rounded-lg shadow-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-gray-900 mb-2">載入隱私政策時出錯</h2>
        <p className="text-gray-600 mb-6">很抱歉，載入隱私政策信息時發生了錯誤。請嘗試重新載入或返回首頁。</p>
